...
<br><br>
        ...
        <div class="container signbox">
		 <h4 class="text-center"><i class="fa fa-sign-in"></i> Enter verification code</h4>
		   ...
		   <br>
		   <form class="form" role="form" action="in_verifycode.php" method="post"><br>
         	<input required  required class="form-control" maxlength="6" type="text" name="vercode" placeholder="Verification Code"/><br>
